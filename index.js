...
app.post('/', function(req, response) {
	...
	action = [
        ...
        superlative = [
              ...
              "a tremendous", "a sensational", "a gorgeous", "a grand", "a fabulous", "a bang tidy"
               ];
        ...
        object = [
               ...
               "burrito","HR violation",'"wut" look from Karen',"+t +d","flash talk","commit message","#wendycorrect","chav","flash talk","peterbutler's head","REST API","WPCLI","Codex", ":poop:","occurrence",
               ""
               ];
